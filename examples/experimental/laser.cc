...
int main(int argc, char* argv[])
{
    ...
    HybridIOAutomaton system = compose("timer-traj",timer,laser_trajectory,DiscreteLocation("work"),DiscreteLocation("passing_right"));
    ...
    Box initial_box(3, /*t*/ 0.0,0.0, /*vx*/ vx_i.lower(),vx_i.upper(), /*x*/ x_i.lower(),x_i.upper());
    HybridEvolver::EnclosureType initial_enclosure(DiscreteLocation("work,passing_right"),initial_box);
