...
void test_constraintset_vs_gridtreeset_operations()
{
	...
	ARIADNE_TEST_EQUAL(possibly_overlapping_subset(gts1,cons).size(),3);
	ARIADNE_TEST_EQUAL(definitely_covered_subset(gts1,cons).size(),0);
	...
	ARIADNE_TEST_EQUAL(possibly_overlapping_subset(gts2,cons).size(),1);
	ARIADNE_TEST_EQUAL(definitely_covered_subset(gts2,cons).size(),0);
	...
	ARIADNE_TEST_EQUAL(possibly_overlapping_subset(gts3,cons).size(),gts3.size());
	ARIADNE_TEST_EQUAL(definitely_covered_subset(gts3,cons).size(),1);
