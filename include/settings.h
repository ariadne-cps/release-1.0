...
VerificationSettings::VerificationSettings() :
    	...
    	allow_quick_proving(true),
    	allow_quick_disproving(true),
...
operator<<(std::ostream& os, const VerificationSettings& p)
{
    os << "VerificationSettings"
       ...
       << ",\n  allow_quick_proving=" << p.allow_quick_proving
       << ",\n  allow_quick_disproving=" << p.allow_quick_disproving
